...
MCP_SERVER_CONFIG = {
    "notion": {
        "type": "stdio",
        "params": {"command": "mcp-notion-server", "args": ["--enabledTools=notion_retrieve_block,notion_retrieve_block_children,notion_append_block_children,notion_retrieve_page"], 
